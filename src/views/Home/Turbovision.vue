<template>
  ...
  <nav class="tui-sidenav absolute">
    <ul>
      ...
      <li>
        <a href="#!"
          >C<span class="red-168-text">u</span>t
    ...
    <ul>
      ...
      <li class="tui-dropdown">
        ...
        <div class="tui-dropdown-content">
          <ul>
            <li>
              <a href="#!"> <span class="red-168-text">N</span>ew </a>
            </li>
            <li>
              <a href="#!">
                <span class="red-168-text">O</span>pen...
            ...
            <li>
              <a href="#!"> Save a<span class="red-168-text">l</span>l </a>
            </li>
            <div class="tui-black-divider"></div>
            ...
            <li class="tui-dropdown block">
              ...
              <div class="tui-dropdown-content">
                <ul>
                  ...
                  <li>
                    <a href="#!"> <span class="red-168-text">P</span>rint </a>
                  </li>
                  <li>
                    <a href="#!">
      ...
      <li class="tui-dropdown"><span class="red-168-text">E</span>dit</li>
      <li class="tui-dropdown"><span class="red-168-text">V</span>iew</li>
      <li class="tui-dropdown"><span class="red-168-text">H</span>elp</li>
    </ul>
  </nav>
  ...
  <div class="tui-window full-width tui-no-shadow" style="margin-top: 20px">
    <fieldset class="tui-fieldset">
      ...
      <span class="tui-fieldset-button"
        ><span class="green-255-text">↕</span></span
      >
      <span class="tui-fieldset-button left"
        ><span class="green-255-text">■</span></span
      >
      <span class="tui-fieldset-text top right" style="margin-right: 50px"
        >1</span
      >
      <span class="tui-fieldset-text" style="margin-left: 50px"
        >&nbsp;1:1&nbsp;</span
      >
      <textarea
        class="tui-textarea full-width"
...
int main() 
{
  ...
  <div class="tui-statusbar absolute">
    <ul>
      <li>
        <a href="#!"><span class="red-168-text">F1</span> Help</a>
      </li>
      <li>
        <a href="#!"><span class="red-168-text">F2</span> Save</a>
      </li>
      <li>
        <a href="#!"><span class="red-168-text">F3</span> Open</a>
      </li>
      <li>
        <a href="#!"><span class="red-168-text">Alt+F9</span> Compile</a>
      </li>
      <span class="tui-statusbar-divider"></span>
      <li>
        <a href="#!"><span class="red-168-text">F10</span> Menu</a>
      </li>
    </ul>
  </div>
</template>